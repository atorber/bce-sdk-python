...
if __name__ == '__main__':
    ...
    # 方式1
    jobcreate_url="http://aihc.bj.baidubce.com/?resourcePoolType=common&withoutAuth=true&action=DescribeResourcePools&pageSize=3"
    print('-------方式1--------')
    print(send_request(jobcreate_url, "get", AK, SK, headers={'version':'v2'}))
    # 方式2
    print('-------方式2--------')
    get_headers(jobcreate_url, "get", ak=AK, sk=SK)
