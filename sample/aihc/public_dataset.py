...
# API基础配置
AIHC_AK='fa0befd5de7a443cb915031e76d123d9'
AIHC_SK='06fe3c0da6c14c8f83164699c8d2f72f'
AIHC_HOST='http://10.209.54.223:8697'
AIHC_BASE_URL='/api/cce/ai-service/v1/aidata/public/dataset'
...
def main():
    ...
    aihc_client = AihcClient(
        BceClientConfiguration(credentials=BceCredentials(AIHC_AK, AIHC_SK),
        endpoint=AIHC_HOST,
    ...
    try:
        response = aihc_client.base_client._aihc_request(
            http_methods.GET, 
            AIHC_BASE_URL+'/list?pageNo=1&pageSize=20&KeywordType=name&keyword=', 
            headers={},
            params={},
            body=None
        )
        ...
        __logger.info('send request success')
...
#   "dataType": "image",
#   "storageType": "s3",
#   "storageInstance": "example-instance",
#   "datasetFormat": "folder",
#   "publisher": "John Doe",
#   "description": "https://console.bce.baidu.com/doc/AIHC/s/Vme16q22e",
